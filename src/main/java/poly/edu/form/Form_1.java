package poly.edu.form;

//import THONGKEDAO.HoaDonBanDAO;
//import THONGKEDAO.HoaDonNhapDAO;
import poly.edu.chart.ModelChart;
//import enitty.HoaDonBan;
//import enitty.HoaDonNhap;
...
//        HoaDonNhap hdn=hdndao.findTienNhap(1);
//        HoaDonNhap hdn1=hdndao.findTienNhap(2);
//        HoaDonNhap hdn2=hdndao.findTienNhap(3);
//        HoaDonNhap hdn3=hdndao.findTienNhap(4);
//        HoaDonNhap hdn4=hdndao.findTienNhap(5);
//        HoaDonNhap hdn5=hdndao.findTienNhap(6);
        
//        HoaDonBan hdb=hdbdao.findDT(1);
        lineChart.addData(new ModelChart("January", new double[]{400,500, 80, 89}));
        lineChart.addData(new ModelChart("February", new double[]{600,70, 90, 150}));
        lineChart.addData(new ModelChart("March", new double[]{200,140, 460, 900}));
        lineChart.addData(new ModelChart("April", new double[]{480, 200, 750, 700}));
        lineChart.addData(new ModelChart("May", new double[]{350, 300, 300, 150}));
        lineChart.addData(new ModelChart("June", new double[]{190,240, 81, 200}));
        lineChart.start();
        progress1.start();
        progress2.start();
        progress3.start();
